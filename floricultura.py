...
class Floricultura:
    ...
    def imprimir_caches(self):
        ...
        for i, cache in enumerate(self.floristas):
            ...
            print(f"Próxima linha a ser substituida pela FIFO é: {cache.fifo_contador}")
        print("\n=========================\n")
    ...
    def leitura(self, florista: Florista, flor: int):
        ...
        print(f"\nFlor não encontrada com outros floristas! Buscando na estufa...")
        ...
        # Caso um estado modified seja substituido 
        if linha_cache_mp.estado == Moesi.M:
            self.write_back(linha_cache_mp)        
    ...
    def escrita(self, florista: Florista, flor: int, novo_valor: int) -> int:
        ...
        # e vamos ter que fazer uma substiuição segundo o algoritmo Fifo
            ...
            print("Flor não encontrada com o florista, buscando... (Write Miss)")
